...
{
    use Concerns\DownloadsBinaries;
    ...
    protected $signature = 'dusk:firefox-driver {version?}
                    ...
                    {--output= : Directory path to store binaries in.}';
    ...
    public function handle()
    {
        ...
        $this->info("Geckodriver binary successfully installed for version $version.");
    }
    ...
    {
        $body = $this->getUrl($this->latestVersionUrl);
